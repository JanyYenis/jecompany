...
<div class="row">
    <div class="col-lg-7">
        <div class="row mb-7">
            <input type="text" name="nombre" value="{{$name}}" id="nombrePlantilla" placeholder="Ingrese el nombre de la plantilla" class="inputG">
        </div>
        <div class="row mb-7">
            <select name="tipo_encabezado" id="selectEncabezado" class="inputG is-invalid" data-control="select2" data-placeholder="Encabezado (opcional)" data-allow-clear="true" data-hide-search="true" data-dropdown-parent="#modalEditarPlantilla">
                <option></option>
                <option {{$header ? 'selected' : '' }} value="1">Texto</option>
                <option {{$header && in_array($header, ['IMAGE', 'VIDEO', 'DOCUMENT']) ? 'selected' : '' }} value="2">Contenido multimedia</option>
            </select>
        </div>
        <div class="row mb-7 seccionTextoEncabezado {{$header && !in_array($header, ['IMAGE', 'VIDEO', 'DOCUMENT']) ? '' : 'd-none' }}">
            <input type="text" name="texto_encabzado" id="textoEncabezado" placeholder="Ingrese el texto" class="inputG">
        </div>
        <div class="row mw-500px mb-5 seccionMultimediaEncabezado {{$header && in_array($header, ['IMAGE', 'VIDEO', 'DOCUMENT']) ? '' : 'd-none' }}" data-kt-buttons="true" data-kt-buttons-target=".form-check-image, .form-check-input">
            <div class="col-4">
                <div class="margen">
                    <label class="form-check-image">
                        ...
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" id="opcionMultimediaImagen" {{$header == 'IMAGE' ? 'checked' : ''}} type="radio" value="1" name="multimedia"/>
                ...
                <div class="margen">                                        
                    <label class="form-check-image">
                        ...
                        <div class="form-check form-check-custom form-check-solid me-10">
                            <input class="form-check-input" id="opcionMultimediaVideo" {{$header == 'VIDEO' ? 'checked' : ''}} type="radio" value="2" name="multimedia" id="text_wow"/>
                            <div class="form-check-label">
                                Video
                            </div>
                        </div>
            ...
            <div class="col-4">
                <div class="margen">
                    <label class="form-check-image">
                        ...
                        <div class="form-check form-check-custom form-check-solid me-10">
                            <input class="form-check-input" id="opcionMultimediaDocumento" {{$header == 'DOCUMENT' ? 'checked' : ''}} type="radio" value="3" name="multimedia"/>
                            <div class="form-check-label">
                                Documento
                            </div>
                        </div>
        ...
        <div class="input-group mb-3 d-none" id="divInputFile">
            ...
            <!--end::Alert-->
            <input type="file" class="inputG" id="inputFile" accept="image/*" name="archivo">
        </div>
        <div class="row mb-7">
            <textarea name="contenido" id="contenidoCampana" cols="30" rows="4" class="inputG" data-kt-autosize="true" maxlength="1020" placeholder="Introduce el texto de tu mensaje">{!! html_entity_decode(nl2br($contenido)) !!}</textarea>
        </div>
        ...
        <div class="row mb-7">
            <select name="boton" id="selectBoton" class="inputG is-invalid" data-control="select2" data-placeholder="Agregar boton (opcional)" data-allow-clear="true" data-hide-search="true" data-dropdown-parent="#modalEditarPlantilla">
                <option></option>
        ...
        <div class="row mb-7 divUrl d-none">
            <div class="input-group mb-5">
                ...
                <input type="text" name="url" class="inputGG" id="basic-url" placeholder="URL" aria-describedby="basic-addon3" style="width: 88%;"/>
            </div>
        </div>
    </div>
    <div class="col-lg-5">
