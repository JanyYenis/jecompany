        ...
        success: function(response) {
            ...
            if (response?.tareasPendientes) {
                response?.tareasPendientes.forEach((tarea) => {
                    ...
                    pendientes.push({
                        'id': tarea.id,
                        'title': `<div class="card mb-6 mb-xl-9">
                    <div class="card-body">
                        <div class="d-flex flex-stack mb-3">
                            ...
                            <div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3 btnEliminar" data-id="${tarea?.id}">
                        ...
                        <div class="fs-6 fw-semibold text-gray-600 mb-5">${tarea?.descripcion ?? 'N/A'}</div>
                        ...
                        <div class="d-flex flex-stack flex-wrapr">
                            ...
                            <div class="d-flex my-1">
                                <div class="border border-dashed border-gray-300 rounded d-flex align-items-center py-2 px-3">
                                    <i class="fas fa-paperclip fs-3"></i> <span
                                        class="ms-1 fs-7 fw-bold text-gray-600">0</span>
                                </div>
                                <div class="border border-dashed border-gray-300 d-flex align-items-center rounded py-2 px-3 ms-3 btnComentario">
                                    <i class="fa fa-comment-alt fs-3"><span class="path1"></span><span
                ...
                boards: [{
                    ...
                    'title': `<div class="mb-9">
                                <div class="d-flex flex-stack">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#modalCrearTarea">
...
const moverTarea = (id, estado = 1) => {
    ...
    const rutaActualizar = route("tareas.actualizarEstado", { tarea: id });
...
const eliminar = (id) => {
    let ruta = route('tareas.delete', { 'tarea': id } );
    let config = {
        "headers": {
            "Accept": generalidades.CONTENT_TYPE_JSON,
