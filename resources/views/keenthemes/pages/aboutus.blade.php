...
@section('breadcrumb')
    <li class="breadcrumb-item text-dark">
        <a href="{{ route('keenthemes.pages.about-us') }}" class="text-dark">About Us</a>
    </li>
@endsection
        ...
        <div class="card-body p-lg-17">
            ...
            <div class="mb-18">
                ...
                <div class="mb-10">
                    ...
                    <div class="overlay">
                        <!--begin::Image-->
                        <img class="w-100 card-rounded" src="{{ asset('assets/media/stock/2000x800/1.jpg')}}"
                            alt="">
                        <!--end::Image-->

                        <!--begin::Links-->
                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            <a href="/blaze-html-pro/pages/pricing.html" class="btn btn-primary">Pricing</a>

                            <a href="/blaze-html-pro/pages/careers/apply.html" class="btn btn-light-primary ms-3">Join
                                Us</a>
                        </div>
                        <!--end::Links-->
                    </div>
                ...
                <div class="fs-5 fw-semibold text-gray-600">
                    ...
                    <p class="mb-8">
                        ...
                        <a href="/blaze-html-pro/pages/blog/post.html" class="link-primary pe-1">Your Post</a>
                    ...
                    <p class="mb-8">
                        ...
                        <a href="/blaze-html-pro/pages/blog/home.html" class="link-primary pe-1">I mean NOTHING</a>
            ...
            <div class="card bg-light mb-18">
                ...
                <div class="card-body py-15">
                        ...
                        <div class="d-flex flex-center flex-wrap mb-10 mx-auto gap-5 w-xl-900px">
                            ...
                            <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                                ...
                                <div class="text-center">
                                    <!--begin::Symbol-->
                                    <i class="ki-duotone ki-element-11 fs-2tx text-primary"><span
                            ...
                            <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-1">
                                        <!--begin::Animation-->
                                        <div class="fs-lg-2hx fs-2x fw-bold text-gray-800 d-flex align-items-center">
                                            <div class="min-w-50px" data-kt-countup="true" data-kt-countup-value="80" data-kt-countup-suffix="K+">0</div>
                                        </div>
                                        <!--end::Animation-->
                            ...
                            <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-1">
                                        <!--begin::Animation-->
                                        <div class="fs-lg-2hx fs-2x fw-bold text-gray-800 d-flex align-items-center">
                                            <div class="min-w-50px" data-kt-countup="true" data-kt-countup-value="35" data-kt-countup-suffix="M+">0</div>
                                        </div>
                                        <!--end::Animation-->
                    ...
                    <div class="fs-2 fw-semibold text-muted text-center">
                        <a href="/blaze-html-pro/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy</a>
                ...
                <div class="row g-10">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-xl-stretch me-md-6">
                            <!--begin::Overlay-->
                            <a class="d-block overlay mb-4" data-fslightbox="gallery"
                                href="{{ asset('assets/media/stock/600x400/img-73.jpg') }}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                    style="background-image:url('{{ asset('assets/media/stock/600x400/img-73.jpg') }}')">
                                </div>
                                <!--end::Image-->
                            ...
                            <div class="m-0">
                                <!--begin::Title-->
                                <a href="/blaze-html-pro/pages/user-profile/overview.html"
                                ...
                                <div class="fs-6 fw-bold">
                                    <!--begin::Author-->
                                    <a href="/blaze-html-pro/apps/projects/users.html"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-xl-stretch mx-md-3">
                            <!--begin::Overlay-->
                            <a class="d-block overlay mb-4" data-fslightbox="gallery"
                                href="{{ asset('assets/media/stock/600x400/img-74.jpg') }}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                    style="background-image:url('{{ asset('assets/media/stock/600x400/img-74.jpg') }}')">
                                </div>
                                <!--end::Image-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-xl-stretch ms-md-6">
                            <!--begin::Overlay-->
                            <a class="d-block overlay mb-4" data-fslightbox="gallery"
                                href="{{ asset('assets/media/stock/600x400/img-47.jpg')}}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                    style="background-image:url('{{ asset('assets/media/stock/600x400/img-47.jpg')}}')">
                                </div>
                                <!--end::Image-->
                ...
                <div class="tns tns-default mb-10 tns-initiazlied">
                    ...
                    <div class="tns-outer" id="tns1-ow">
                        <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span
                                class="current">9 to 11</span> of 7</div>
                                ...
                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                    ...
                                    <div class="text-center tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                        ...
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-20.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                                    ...
                                    <div class="text-center tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-24.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                                    ...
                                    <div class="text-center tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-12.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                                    ...
                                    <div class="text-center tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-9.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                                    ...
                                    <div class="text-center tns-item" id="tns1-item1" aria-hidden="true" tabindex="-1">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-2.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                                    ...
                                    <div class="text-center tns-item" id="tns1-item2" aria-hidden="true" tabindex="-1">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{asset('assets/media/avatars/150-5.jpg')}}')">
                                        </div>
                                        <!--end::Photo-->
                    ...
                    <!--begin::Button-->
                    <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_prev" aria-controls="tns1"
                        tabindex="-1" data-controls="prev">
                        <i class="fas fa-chevron-left fs-3x"></i> </button>
                    <!--end::Button-->

                    <!--begin::Button-->
                    <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_next" aria-controls="tns1"
                        tabindex="-1" data-controls="next">
                        <i class="fas fa-chevron-right fs-3x"></i> </button>
                    <!--end::Button-->
                </div>
                <!--end::Slider-->
            </div>
            ...
            <div class="card mb-4 bg-light text-center ">
                ...
                <div class="card-body py-12">
                    ...
                    <!--begin::Icon-->
                    <a href="#" class="mx-4">
                        <img src="{{asset('assets/media/svg/brand-logos/github.svg')}}" class="h-30px my-2"
                            alt="">
                    </a>
                    <!--end::Icon-->
                    ...
                    <!--begin::Icon-->
                    <a href="#" class="mx-4">
                        <img src="{{asset('assets/media/svg/brand-logos/behance.svg')}}" class="h-30px my-2"
                            alt="">
                    </a>
                    <!--end::Icon-->
                    ...
                    <!--begin::Icon-->
                    <a href="#" class="mx-4">
                        <img src="{{asset('assets/media/svg/brand-logos/pinterest-p.svg')}}" class="h-30px my-2"
                            alt="">
                    </a>
                    <!--end::Icon-->
                    ...
                    <!--begin::Icon-->
                    <a href="#" class="mx-4">
                        <img src="{{asset('assets/media/svg/brand-logos/dribbble-icon-1.svg')}}" class="h-30px my-2"
                            alt="">
                    </a>
                    <!--end::Icon-->
                </div>
