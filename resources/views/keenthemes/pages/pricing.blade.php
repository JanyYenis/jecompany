...
@section('breadcrumb')
    <li class="breadcrumb-item text-dark">
        <a href="{{ route('keenthemes.pages.pricing') }}" class="text-dark">Pricing</a>
    </li>
@endsection
                            ...
                            <td>
                                <div class="flex-root d-flex justify-content-center">
                                    ...
                                    <span class="h-40px w-40px d-flex flex-center d-none">
                                        <i class="fas fa-times fs-2x text-0"><span class="path1"></span><span
                                                class="path2"></span></i>
                                    </span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-root d-flex justify-content-center">
                                    ...
                                    <span class="h-40px w-40px d-flex flex-center d-block">
                                        <i class="fas fa-times fs-2x text-danger"><span class="path1"></span><span
                                                class="path2"></span></i>
                                    </span>
                                </div>
                            </td>
