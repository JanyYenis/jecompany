...
@section('content')
	<div class="summernote"><p>jQueryScript.Net</p></div>
    <div class="contenedor">
		...
		<div class="row">
            ...
            <div class='col-md-6 text-center'>
                ...
                <input type="range" id="puntero" class='form-range' min="1" default="1" max="5" width="10%">
			</div>
			<div class='col-md-12 text-center mt-2'>
				<input type="button" class="btn btn-success" id="draw-submitBtn" value="Crear Imagen"></input>
				<input type="button" class="btn btn-danger" id="draw-clearBtn" value="Borrar Canvas"></input>
			</div>
		</div>
		<br/>
		<div class="row">
