            ...
            <div class="d-flex flex-column align-items-end">
                <div class="d-flex align-items-center mb-2">
                    <div class="me-3">
                        ...
                        <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">Tu</a>
                    </div>
        ...
        <div class="d-flex justify-content-start mb-10 ">
            <div class="d-flex flex-column align-items-start">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="ms-3">
                        <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">{{$mensaje->deU->nombre_completo}}</a>
                        <span class="text-muted fs-7 mb-1">{{$mensaje->created_at}}</span>
                    </div>
                </div>
