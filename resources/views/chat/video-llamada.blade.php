...
<body>
    <div class="video-container">
        <video id="remoteVideo" class="video remote-video" autoplay playsinline></video>
        <video id="localVideo" class="video local-video" autoplay muted playsinline></video>
        <div class="control-bar">
            <button type="button" id="muteAudio" class="btn btn-danger">
                <i class="fas fa-microphone-slash fs-1"></i>
            </button>
            <button type="button" id="muteVideo" class="btn btn-danger">
                <i class="fas fa-video-slash fs-1"></i>
            </button>
    ...
    <script src="{{ mix('/js/chat/videoLlamada.js') }}" ></script>
