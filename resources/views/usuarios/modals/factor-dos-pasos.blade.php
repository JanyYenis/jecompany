    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header flex-stack">
                <!--begin::Title-->
                <h2>Elija un método de autenticación</h2>
                <!--end::Title-->
                    ...
                    <div class="pb-10">
                        ...
                        <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center mb-5"
                            ...
                            <span class="d-block fw-semibold text-start">
                                <span class="text-gray-900 fw-bold d-block fs-3">Aplicación Authenticator</span>
                ...
                <div class="d-none" data-kt-element="apps">
                    ...
                    <form data-kt-element="apps-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" id="formVerificacionApps">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <input type="text" class="form-control form-control-lg form-control-solid" placeholder="Ingrese el código" name="code">
